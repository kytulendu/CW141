...
int createdir(char mask[])
{
    ...
    while (!done) {
      ...
      if (tempdir->next == NULL) {
        blockmsg(10);
        dispstrhgc("ÀπË«¬§«“¡®”‰¡ËæÕ ! °¥ <ESC> ‡æ◊ËÕ∑”ß“πµËÕ",27,10,2);
...
{
    int col,row;
    dispstrhgc(" òïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïô ",9,8,2);
    dispstrhgc(" ñ                                                                   ñ ",9,9,2);
    dispstrhgc(" ñ                                                                   ñ ",9,10,2);
    dispstrhgc(" ñ                                                                   ñ ",9,11,2);
    dispstrhgc(" ñ                                                                   ñ ",9,12,2);
    dispstrhgc(" ñ                                                                   ñ ",9,13,2);
    dispstrhgc(" öïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïïõ ",9,14,2);
